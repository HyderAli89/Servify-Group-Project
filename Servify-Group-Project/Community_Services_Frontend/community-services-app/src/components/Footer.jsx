        ...
        <div className="flex justify-between">
          ...
          {user === null && (
            <ul className="flex flex-col gap-y-1">
              ...
              <li className="text-gray-600 text-sm">
                <Link to="/employee/signup" onClick={window.scrollTo(0, 0)}>Register as a professional</Link>
              </li>
              <li className="text-gray-600 text-sm">
                <Link to="/employee/login" onClick={window.scrollTo(0, 0)}>login as a professional</Link>
              </li>
            </ul>
          )}
          <ul className="flex flex-col gap-y-1">
