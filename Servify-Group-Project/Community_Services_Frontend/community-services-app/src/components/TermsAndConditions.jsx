        ...
        <div className="bg-white shadow-lg rounded-lg p-8 max-w-4xl w-full">
          ...
          <main className="space-y-6">
            ...
            <p className="leading-relaxed text-gray-700">
              ...
              incorporated under the Companies Act, 2024 with its registered
              address at R-5, ABC House Green Park Market, Ahmedabad 380051 , and
              its principal place of business at 416, SAFAL TOWER III, Sector
              10, AHMEDABAD, GUJARAT 380051 and its affiliates (
